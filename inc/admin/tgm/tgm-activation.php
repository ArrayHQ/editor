 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Editor
...
add_action( 'tgmpa_register', 'editor_register_required_plugins' );
 ...
 */
function editor_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'editor_wpforms_shareasale_id' );

function editor_wpforms_shareasale_id( $shareasale_id ) {
